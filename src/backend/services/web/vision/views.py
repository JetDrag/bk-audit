...
class ShareViewSet(BKVisionViewSet):
    resource_routes = [
        ResourceRoute("GET", resource.vision.query_share_list, endpoint="query_share_list"),
        ResourceRoute("GET", resource.vision.query_share_detail, endpoint="query_share_detail"),
    ]
